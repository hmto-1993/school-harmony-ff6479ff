...
export default function StudentSummaryCards({ vis, percentage, presentCount, absentCount, positiveCount, negativeCount }: Props) {
  ...
  return (
    <div className={cn("grid gap-4", visibleCount <= 2 ? "grid-cols-2" : "grid-cols-2 md:grid-cols-4")}>
      {vis.grades && (
        <Card className="border-0 shadow-lg bg-gradient-to-br from-primary/10 via-card to-primary/15 overflow-hidden">
      ...
      {vis.attendance && (
        <>
          <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-500/10 via-card to-emerald-500/15 overflow-hidden">
            <CardContent className="flex flex-col items-center p-5">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-rose-500/10 via-card to-rose-500/15 overflow-hidden">
            <CardContent className="flex flex-col items-center p-5">
      ...
      {vis.behavior && (
        <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-500/10 via-card to-blue-500/15 overflow-hidden">
          <CardContent className="flex flex-col items-center p-5">
