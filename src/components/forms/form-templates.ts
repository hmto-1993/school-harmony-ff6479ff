...
export const formTemplates: FormTemplate[] = [
  ...
  },
  {
    ...
    bodyTemplate:
      "شهادة تميز سلوكي\n\nيُمنح الطالب/ {student_name} المقيد في فصل/ {class_name} هذه البطاقة تقديراً لسلوكه المثالي ومساهمته الفعالة في إنجاح الحصة الدراسية، مما يمنحه الأولوية في نقاط التميز بنظام (منصة المتميز التعليمية).\n\nالدرجة الممنوحة: {score}\n\nالسجل المدني: {national_id}\nالتاريخ: {date}",
  ...
  },
  {
    ...
    confidentialWatermark: true,
    bodyTemplate:
      "محضر اجتماع لجنة التوجيه الطلابي\n\n⚠️ سري للغاية\n\nإنه في يوم/ {meeting_day} الموافق/ {date} عقدت لجنة التوجيه الطلابي اجتماعاً لدراسة حالة الطالب/ {student_name} المقيد في فصل/ {class_name} والمسجلة في منصة منصة المتميز التعليمية.\n\nوبعد الاطلاع على سجل السلوك والبيانات، توصي اللجنة بالآتي:\n\nالحاضرون:\n{attendees}\n\nجدول الأعمال:\n{agenda}\n\nتوصيات وقرارات اللجنة:\n{decisions}\n\nالسجل المدني: {national_id}",
