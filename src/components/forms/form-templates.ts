...
export const formTemplates: FormTemplate[] = [
  ...
  // ====== FORM #10 — إشعار ولي الأمر بمشكلة سلوكية (مطابق ص67) ======
  {
    ...
    tableLayout: [
      { type: "paragraph", text: "سري", bold: true, align: "center", spacing: 4 },
      { type: "paragraph", text: "المكرم ولي أمر الطالب/الطالبة: {student_name}", bold: true, spacing: 2 },
      { type: "paragraph", text: "بالصف: {class_name}", spacing: 4 },
      { type: "paragraph", text: "السلام عليكم ورحمة الله وبركاته،", spacing: 4 },
      { type: "paragraph", text: "نُشعركم بأن الطالب/الطالبة قام/قامت بمشكلة سلوكية من الدرجة: {issue_degree}", spacing: 2 },
      { type: "paragraph", text: "وهي: {issue_desc}", spacing: 4 },
      { type: "paragraph", text: "وقد اتُخذت الإجراءات التالية حياله/حيالها وفق ما ورد في قواعد السلوك والمواظبة:", spacing: 3 },
      { type: "paragraph", text: "1. {action_1}", spacing: 2 },
      { type: "paragraph", text: "2. {action_2}", spacing: 2 },
      { type: "paragraph", text: "3. {action_3}", spacing: 4 },
