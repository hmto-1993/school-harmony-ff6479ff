...
export const formTemplates: FormTemplate[] = [
  ...
  },
  {
    ...
    bodyTemplate:
      "شهادة تميز سلوكي\n\nيُمنح الطالب/ {student_name} المقيد في فصل/ {class_name} هذه البطاقة تقديراً لسلوكه المثالي ومساهمته الفعالة في إنجاح الحصة الدراسية، مما يمنحه الأولوية في نقاط التميز بنظام (منصة المتميز الرقمية).\n\nالدرجة الممنوحة: {score}\n\nالسجل المدني: {national_id}\nالتاريخ: {date}",
