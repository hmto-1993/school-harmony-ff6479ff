      ...
      <CardContent className="p-3">
        ...
        >
          ...
          <div style={{
            ...
            {/* Left section */}
            <div style={{ flex: "1 1 0%" }}>
              <div style={{ width: "fit-content", maxWidth: "100%", marginLeft: "auto", textAlign: "right", fontSize: `${config.leftSection.fontSize * 0.7}px`, lineHeight: 1.8, color: config.leftSection.color || "#1e293b" }}>
