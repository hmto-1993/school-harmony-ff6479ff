    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { key: "parent_portal", icon: Heart, label: "التحكم ببوابة ولي الأمر", desc: `${[s.parentShowGrades ? "الدرجات" : "", s.parentShowAttendance ? "الحضور" : "", s.parentShowBehavior ? "السلوك" : ""].filter(Boolean).join(" · ") || "الكل مخفي"}`, gradient: "from-pink-500 to-rose-600", shadow: "shadow-pink-500/20", adminOnly: true },
