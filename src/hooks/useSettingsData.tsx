...
export function useSettingsData() {
  ...
  const fetchData = async () => {
    ...
    const loginQuery = isAdmin ? supabase.from("site_settings").select("id, value").in("id", scopedIds(["school_name", "school_subtitle", "school_logo_url", "default_academic_year", "dashboard_title", "education_department"])) : Promise.resolve({ data: null });
